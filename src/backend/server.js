...
import { OPENAI_CONFIG } from './constants.js'  // Ajout de l'import
      ...
      messages: [
        {
          role: "user",
          content: [
            { type: "text", text: "Analyze this food image andPlease, give a estimation of the following informations and provide only these details in JSON format: {'calories': number, 'protein': number, 'carbs': number, 'fat': number}" },
            {
              type: "image_url",
              image_url: {
                url: base64Image
